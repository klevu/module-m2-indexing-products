...
class KlevuRatingCountAttributeValidator extends AbstractValidator implements ValidatorInterface
{
    /**
     ...
     * @return bool
     */
    public function isValid(mixed $value = KlevuRatingCountInterface::ATTRIBUTE_CODE): bool
    {
        $this->_clearMessages();
