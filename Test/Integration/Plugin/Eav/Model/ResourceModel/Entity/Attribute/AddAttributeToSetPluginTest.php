...
namespace Klevu\IndexingProducts\Test\Integration\Plugin\Eav\Model\ResourceModel\Entity\Attribute;
...
/**
 * @covers \Klevu\Indexing\Plugin\Eav\Model\ResourceModel\Entity\Attribute\AddAttributeToSetPlugin::class
 */
class AddAttributeToSetPluginTest extends TestCase
{
    use AttributeTrait;
    ...
    public function testSaveInSetIncluding(): void
    {
        ...
        $this->createStore(
            storeData: [
                'key' => 'klevu_test_attributesetplugin',
                'code' => 'klevu_test_attributesetplugin',
                'name' => 'Klevu Test: Attribute Set Save Plugin',
                'is_active' => true,
            ],
        );
        $storeFixture = $this->storeFixturesPool->get('klevu_test_attributesetplugin');
        ...
        $attributeFixture = $this->attributeFixturePool->get('klevu_test_attributesetplugin');
        /** @var ProductAttributeInterface|AbstractAttribute $attribute */
        $attribute = $attributeFixture->getAttribute();

        $this->removeAttributeSetByName('klevu_test_attributesetplugin');
        $attributeSet = $this->createAttributeSet(
            attributes: [
                $attribute,
            ],
            data: [
                'attribute_set_name' => 'klevu_test_attributesetplugin',
                'entity_type_id' => 4,
            ],
        );
        ...
        $this->createProduct(
            productData: [
                'key' => 'klevu_test_attributesetplugin_1',
                'sku' => 'klevu_test_attributesetplugin_1',
                'name' => 'Klevu Test: Attribute Set Save Plugin (1)',
        ...
        $productFixture1 = $this->productFixturePool->get('klevu_test_attributesetplugin_1');

        $this->createProduct(
            productData: [
                'key' => 'klevu_test_attributesetplugin_2',
                'sku' => 'klevu_test_attributesetplugin_2',
                'name' => 'Klevu Test: Attribute Set Save Plugin (2)',
                'status' => SourceStatus::STATUS_ENABLED,
                'visibility' => Visibility::VISIBILITY_BOTH,
                'in_stock' => true,
                'qty' => 100,
        ...
        $productFixture2 = $this->productFixturePool->get('klevu_test_attributesetplugin_2');

        $this->createProduct(
            productData: [
                'key' => 'klevu_test_attributesetplugin_3',
                'sku' => 'klevu_test_attributesetplugin_3',
                'name' => 'Klevu Test: Attribute Set Save Plugin (3)',
                'status' => SourceStatus::STATUS_ENABLED,
                'visibility' => Visibility::VISIBILITY_BOTH,
                'in_stock' => true,
                'qty' => 100,
        ...
        $productFixture3 = $this->productFixturePool->get('klevu_test_attributesetplugin_3');

        $this->createProduct(
            productData: [
                'key' => 'klevu_test_attributesetplugin_4',
                'sku' => 'klevu_test_attributesetplugin_4',
                'name' => 'Klevu Test: Attribute Set Save Plugin (4)',
                'status' => SourceStatus::STATUS_ENABLED,
                'visibility' => Visibility::VISIBILITY_BOTH,
                'in_stock' => true,
                'qty' => 100,
        ...
        $productFixture4 = $this->productFixturePool->get('klevu_test_attributesetplugin_4');

        ConfigFixture::setForStore(
            path: 'klevu_configuration/auth_keys/js_api_key',
            value: $apiKey,
            storeCode: 'klevu_test_attributesetplugin',
        );
        ConfigFixture::setForStore(
        ...
        $attributeResource = $this->objectManager->get(AttributeResource::class);
        ...
        $attribute->setData(
            ...
            value: $this->getAttributeGroupId($attributeSetId),
        );
        $attributeResource->saveInSetIncluding(
            object: $attribute,
        );
