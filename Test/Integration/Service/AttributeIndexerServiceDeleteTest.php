...
use Klevu\IndexingProducts\Service\AttributeIndexerService\Delete as DeleteAttributeIndexerServiceVirtualType;
...
class AttributeIndexerServiceDeleteTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = DeleteAttributeIndexerServiceVirtualType::class; // @phpstan-ignore-line
    ...
    public function testExecute_CallsSdkPutAndUpdatesIndexingAttribute(): void
    {
        ...
        $this->mockSdkAttributeDeleteApiCall(
            isCalled: true,
            isSuccessful: true,
            message: 'Successfully deleted attribute klevu-test-attribute-1.',
        );
        ...
        $this->assertContains(
            needle: 'Successfully deleted attribute klevu-test-attribute-1.',
        ...
        $this->assertSame(expected: Actions::DELETE, actual: $indexingAttribute1->getLastAction());
        $this->assertnotNull(actual: $indexingAttribute1->getLastActionTimestamp());
        $this->assertFalse(condition: $indexingAttribute1->getIsIndexable());
     ...
     * @magentoAppIsolation enabled
     */
    public function testExecute_DeletesIndexingAttributeForDeletedMagentoAttribute(): void
    {
        $apiKey1 = 'klevu-test-js-api-key-1';
        $apiKey2 = 'klevu-test-js-api-key-2';
        $this->createStore([
        ...
        $attributeRepository->delete($attributeFixture->getAttribute());
