...
use Klevu\IndexingProducts\Service\AttributeIndexerService\Update as UpdateAttributeIndexerServiceVirtualType;
...
class AttributeIndexerServiceUpdateTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = UpdateAttributeIndexerServiceVirtualType::class; // @phpstan-ignore-line
    ...
    public function testExecute_CallsSdkPutAndUpdatesIndexingAttribute(): void
    {
        ...
        $this->mockSdkAttributePutApiCall(
            isCalled: true,
            isSuccessful: true,
            message: 'Successfully updated attribute klevu-test-attribute-1.',
        );
        ...
        $this->assertContains(
            needle: 'Successfully updated attribute klevu-test-attribute-1.',
        ...
        $this->assertSame(expected: Actions::UPDATE, actual: $indexingAttribute1->getLastAction());
        ...
        $this->assertSame(expected: Actions::ADD, actual: $indexingAttribute3->getNextAction());
