...
class StatusTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = StatusCriteria::class;
    ...
    public function testExecute_WithoutOrigValue(): void
    {
        ...
        $productStatusProviderMock = $this->getMockProductStatusProvider();
        $productStatusProviderMock->expects($this->never())
            ->method('get');

        /** @var StatusCriteria $statusCriteria */
        $statusCriteria = $this->instantiateTestObject([
            'productStatusProvider' => $productStatusProviderMock,
        ]);
    ...
    public function testExecute_SingleStore_DifferentApiKey_NoParent(): void
    {
        $this->createStore(
            storeData: [
                'key' => 'klevu_test_status_criteria_1',
                'code' => 'klevu_test_status_criteria_1',
                'name' => 'Klevu Test: Status Criteria (1)',
                'is_active' => true,
            ],
        );
        $storeFixture1 = $this->storeFixturesPool->get('klevu_test_status_criteria_1');
        ...
        $this->createProduct(
            productData: [
                'key' => 'klevu_test_status_criteria_1',
                'sku' => 'klevu_test_status_criteria_1',
                'name' => 'Klevu Test: Status Criteria (1)',
        ...
        $productFixture1 = $this->productFixturePool->get('klevu_test_status_criteria_1');
        ...
        $indexingEntity->setRequiresUpdate(true);
        $indexingEntity->addRequiresUpdateOrigValue(
            criteria: StatusCriteria::CRITERIA_IDENTIFIER,
            value: true,
        );
    ...
    public function testExecute_SingleStore_ApiKeyMatches_NoParent(
        ...
        $productStatusProviderMock = $this->getMockProductStatusProvider();
        $productStatusProviderMock->expects($this->once())
            ->method('get')
            ->willReturnCallback(
                callback: function (
    ...
    public function testExecute_MultipleStores_NoParent(
        ...
        $storeFixtures[0] = $this->storeFixturesPool->get('klevu_test_status_criteria_1');
        ...
        $this->createStore(
            storeData: [
                'key' => 'klevu_test_status_criteria_2',
                'code' => 'klevu_test_status_criteria_2',
                'name' => 'Klevu Test: Status Criteria (2)',
                'is_active' => true,
            ],
        );
        $storeFixtures[1] = $this->storeFixturesPool->get('klevu_test_status_criteria_2');
        ...
        $this->createStore(
            storeData: [
                'key' => 'klevu_test_status_criteria_3',
                'code' => 'klevu_test_status_criteria_3',
                'name' => 'Klevu Test: Status Criteria (3)',
                'is_active' => true,
            ],
        );
        $storeFixtures[2] = $this->storeFixturesPool->get('klevu_test_status_criteria_3');
        ...
        $productStatusProviderMock->expects($expectation)
            ->method('get')
            ->willReturnCallback(
                callback: function (
                    ProductInterface $product,
    ...
    public function testExecute_SingleStore_WithParent(
        ...
        $this->createProduct(
            productData: [
                'key' => 'klevu_test_status_criteria_2',
                'sku' => 'klevu_test_status_criteria_2',
                'name' => 'Klevu Test: Status Criteria (2)',
                'status' => SourceStatus::STATUS_ENABLED,
                'visibility' => Visibility::VISIBILITY_BOTH,
                'in_stock' => true,
        ...
        $productFixture2 = $this->productFixturePool->get('klevu_test_status_criteria_2');
    ...
    /**
     * @return MockObject&ProductStatusProviderInterface
     */
    private function getMockProductStatusProvider(): MockObject
    {
        return $this->getMockBuilder(ProductStatusProviderInterface::class)
