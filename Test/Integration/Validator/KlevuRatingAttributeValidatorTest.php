...
use Klevu\IndexingProducts\Validator\KlevuRatingAttributeValidator;
...
/**
 * @covers KlevuRatingAttributeValidator
 * @method KlevuRatingAttributeValidator instantiateTestObject(?array $arguments = null)
 */
class KlevuRatingAttributeValidatorTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = KlevuRatingAttributeValidator::class;
