...
use Klevu\IndexingProducts\Setup\Patch\Data\CreateKlevuRatingCountAttribute;
...
class CreateKlevuRatingCountAttributeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = CreateKlevuRatingCountAttribute::class;
        ...
        $mockLogger->expects($this->once())
            ...
            ->with(
                ...
                [
                    ...
                    'method' => 'Klevu\IndexingProducts\Setup\Patch\Data\CreateKlevuRatingCountAttribute::apply',
