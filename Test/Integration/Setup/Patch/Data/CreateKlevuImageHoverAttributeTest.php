...
use Klevu\IndexingProducts\Model\Attribute\KlevuImageHoverInterface as KlevuImageHoverAttribute;
use Klevu\IndexingProducts\Setup\Patch\Data\CreateKlevuImageHoverAttribute;
...
class CreateKlevuImageHoverAttributeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = CreateKlevuImageHoverAttribute::class;
    ...
    public function testApply_LogsError_WhenExceptionThrow_DuringAttributeCreation(): void
    {
        ...
        $mockLogger->expects($this->once())
            ...
            ->with(
                ...
                [
                    'attributeCode' => KlevuImageHoverAttribute::ATTRIBUTE_CODE,
                    'method' => 'Klevu\IndexingProducts\Setup\Patch\Data\CreateKlevuImageHoverAttribute::apply',
    ...
    public function testApply_LogsError_WhenExceptionThrow_DuringAttributeSetAssignment(): void
    {
        $exceptionMessage = sprintf(
            ...
            KlevuImageHoverAttribute::ATTRIBUTE_CODE,
            Product::ENTITY,
        );
