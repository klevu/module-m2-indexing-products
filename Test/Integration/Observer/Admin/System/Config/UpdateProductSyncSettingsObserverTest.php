...
class UpdateProductSyncSettingsObserverTest extends TestCase
{
    ...
    private const OBSERVER_NAME = 'Klevu_IndexingProducts_adminSystemConfig_updateProductSyncSettings';
    ...
    public function testExecute_ExcludeOutOfStockProductsPathChanged(): void
    {
        $mockCreateCronScheduleAction = $this->getMockCreateCronScheduleAction();
        $mockCreateCronScheduleAction->expects($this->once())
            ->method('execute');
