 ...
 */
class AddAttributeObserverTest extends TestCase
{
    use AttributeTrait;
    ...
    private const OBSERVER_NAME = 'Klevu_IndexingProducts_syncAddAttribute';
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = AddAttributeObserverVirtualType::class;
        $this->interfaceFqcn = ObserverInterface::class;
        $this->implementationForVirtualType = AddAttributeObserver::class;
    ...
    public function testObserver_IsConfigured(): void
    {
        ...
        $this->assertSame(
            expected: ltrim(string: AddAttributeObserverVirtualType::class, characters: '\\'),
    ...
    public function testExecute_LogsError_WhenAttributeMapperThrowsException(): void
    {
        ...
        $mockLogger->expects($this->once())
            ...
            ->with(
                ...
                [
                    'method' => 'Klevu\Indexing\Observer\Sync\Attributes\AddAttributeObserver::execute',
    ...
    public function testExecute_SetsIndexingAttributeLastAction(): void
    {
        ...
        $this->assertSame(expected: Actions::ADD, actual: $updateIndexingAttribute->getLastAction());
    }
